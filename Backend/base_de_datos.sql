...
-- inserciones person
INSERT INTO persons (UserName, FirstName, LastName1, LastName2, Email, PersonTypeId, Password) VALUES 
('marcos13','Marcos','Magaña','Perez','marcos@gardening.es',1,"password"),
('ruben15','Ruben','López','Martinez','rlopez@gardening.es',2,"password"),
('alberto21','Alberto','Soria','Carrasco','asoria@gardening.es',3,"password"),
('maria451','Maria','Solís','Jerez','msolis@gardening.es',4,"password"),
('felipe541','Felipe','Rosas','Marquez','frosas@gardening.es',5,"password"),
('cortiz845','Juan Carlos','Ortiz','Serrano','cortiz@gardening.es',5,"password"),
('csoria54','Carlos','Soria','Jimenez','csoria@gardening.es',6,"password"),
('mlopez654','Mariano','López','Murcia','mlopez@gardening.es',5,"password"),
('lcampoamor494','Lucio','Campoamor','Martín','lcampoamor@gardening.es',5,"password"),
('hrodriguez651','Hilario','Rodriguez','Huertas','hrodriguez@gardening.es',5,"password"),
('manu54','Emmanuel','Magaña','Perez','manu@gardening.es',6,"password"),
('jmmart75','José Manuel','Martinez','De la Osa','jmmart@hotmail.es',5,"password"),
('dpalma64','David','Palma','Aceituno','dpalma@gardening.es',5,"password"),
('opalma15','Oscar','Palma','Aceituno','opalma@gardening.es',5,"password"),
('ffignon78','Francois','Fignon','','ffignon@gardening.com',6,"password"),
('lnarvaez6512','Lionel','Narvaez','','lnarvaez@gardening.com',5,"password"),
('lserra21','Laurent','Serra','','lserra@gardening.com',5,"password"),
('mbolton30','Michael','Bolton','','mbolton@gardening.com',6,"password"),
('wssanchez5','Walter Santiago','Sanchez','Lopez','wssanchez@gardening.com',5,"password"),
('hwashington156','Hilary','Washington','','hwashington@gardening.com',6,"password"),
('mpaxton51','Marcus','Paxton','','mpaxton@gardening.com',5,"password"),
('lpaxton156','Lorena','Paxton','','lpaxton@gardening.com',5,"password"),
('nnishikori','Nei','Nishikori','','nnishikori@gardening.com',6,"password"),
('nriko14','Narumi','Riko','','nriko@gardening.com',5,"password"),
('tnomura156','Takuma','Nomura','','tnomura@gardening.com',5,"password"),
('ajohnson4145','Amy','Johnson','','ajohnson@gardening.com',6,"password"),
('lwestfalls561','Larry','Westfalls','','lwestfalls@gardening.com',5,"password"),
('jwalton44','John','Walton','','jwalton@gardening.com',5,"password"),
('kfalmer61','Kevin','Fallmer','','kfalmer@gardening.com',6,"password"),
('jbellinelli561','Julian','Bellinelli','','jbellinelli@gardening.com',5,"password"),
('mkishi615','Mariko','Kishi','','mkishi@gardening.com',5,"password"),
('daniel.g651','Daniel G','GoldFish','','daniel.g@gardening.com',7,"password"),
('anne45','Anne','Wright','','anne.w@gardening.com',7,"password"),
('link416','Link','Flaute','','link.f@gardening.com',7,"password"),
('akane165','Akane','Tendo','','akane.t@gardening.com',7,"password"),
('antoni15','Antonio','Lasas','','antonio.l@gardening.com',7,"password"),
('jose5487','Jose','Bermejo','','jose.b@gardening.com',7,"password"),
('paco454','Paco','Lopez','','paco.l@gardening.com',7,"password"),
('guillermo416','Naturagua','Guillermo','','guillermo.r@gardening.com',7,"password"),
('david156','David','Serrano','','david.s@gardening.com',7,"password"),
('jos4514','Jose','Tacaño','','jose.t@gardening.com',7,"password"),
('antonio456','Antonio','Lasas','','antonio.l@gardening.com',7,"password"),
('pedro5156','Pedro','Camunas','','pedro.c@gardening.com',7,"password"),
('juan562','Juan','Rodriguez','','juan.r@gardening.com',7,"password"),
('javier45145','Javier','Villar','','javier.v@gardening.com',7,"password"),
('maria562','Maria','Rodriguez','','maria.r@gardening.com',7,"password"),
('beatriz516','Beatriz','Fernandez','','beatriz.f@gardening.com',7,"password"),
('victoria5616','Victoria','Cruz','','victoria.c@gardening.com',7,"password"),
('luis156','Luis','Martinez','','luis.m@gardening.com',7,"password"),
('mario45156','Mario','Suarez','','mario.s@gardening.com',7,"password"),
('cristian562','Cristian','Rodrigez','','cristian.r@gardening.com',7,"password"),
('francisco5616','Francisco','Camacho','','francisco.c@gardening.com',7,"password"),
('maria45156','Maria','Santillana','','maria.s@gardening.com',7,"password"),
('federico6512','Federico','Gomez','','federico.g@gardening.com',7,"password"),
('tony156','Tony','Muñoz Mena','','tony.m@gardening.com',7,"password"),
('eva45156','Eva María','Sánchez','','eva.s@gardening.com',7,"password"),
('matias45156','Matías','San Martín','','matias.s@gardening.com',7,"password"),
('benito155','Benito','Lopez','','benito.l@gardening.com',7,"password"),
('joseluis45156','Joseluis','Sanchez','','joseluis.s@gardening.com',7,"password"),
('sara156','Sara','Marquez','','sara.m@gardening.com',7,"password"),
('luis54','Luis','Jimenez','','luis.j@gardening.com',7,"password"),
('francois5145','FraÃ§ois','Toulou','','francois.t@gardening.com',7,"password"),
('pierre541','Pierre','Delacroux','','pierre.d@gardening.com',7,"password"),
('jacob54','Jacob','Jones','','jacob.j@gardening.com',7,"password"),
('antonio562','Antonio','Romero','','antonio.r@gardening.com',7,"password"),
('richard156','Richard','Mcain','','richard.m@gardening.com',7,"password"),
('justin45156','Justin','Smith','','justin.s@gardening.com',7,"password");
